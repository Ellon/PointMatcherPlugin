/*=========================================================================
  ...
  Module:    vtkPMMaxDensityDataPointsFilter.cxx
...
//----------------------------------------------------------------------------
vtkStandardNewMacro(vtkPMMaxDensityDataPointsFilter);

//----------------------------------------------------------------------------
vtkPMMaxDensityDataPointsFilter::vtkPMMaxDensityDataPointsFilter()
{
  this->MaxDensity = 10;
...
//----------------------------------------------------------------------------
int vtkPMMaxDensityDataPointsFilter::RequestData(
  ...
  vtkInformationVector *outputVector)
{
  ...
  std::string name = "MaxDensityDataPointsFilter";
  params["maxDensity"] = boost::lexical_cast<std::string>(this->MaxDensity);
...
//----------------------------------------------------------------------------
void vtkPMMaxDensityDataPointsFilter::PrintSelf(ostream& os, vtkIndent indent)
{
